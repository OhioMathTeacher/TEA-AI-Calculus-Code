...
*(Instructions in parentheses are for the AI to follow and should **never** appear in the final memo.)*
...
**IMPORTANT:** Table format **must match exactly**: `Page | Student Words | AI Words | % Student Talk`
...
**Note:** All memos must maintain this structure, headings, and depth. Analytical content must be tailored to the specific transcript, but formatting and section presence are non-negotiable.
